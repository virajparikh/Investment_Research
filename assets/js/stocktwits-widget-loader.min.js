...
"font","font_option","font_size","text_color","time_color","time_font_size"],m=b.ssl?"https://":"http://",n=document.getElementById(b.container||"stocktwits-widget"),c,f,g,j;a.setAttribute("allowtranparency","true");a.setAttribute("frameBorder","0");a.setAttribute("border","0");a.setAttribute("style","border: 0");a.setAttribute("scrolling","no");f=/\d+/.test(b.width)?b.width:300;g=/\d+/.test(b.height)?b.height:300;a.style.width=f+"px";a.style.height=g+"px";e.add("width",f);e.add("height",g);e.add("domain",
